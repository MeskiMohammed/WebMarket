<aside
    ...
    <div class="h-19.5">
        <svg width="24px" height="24px" viewBox="0 0 1024.00 1024.00" xmlns="http://www.w3.org/2000/svg" fill="#000000"
            class="absolute top-0 right-0 hidden cursor-pointer fas fa-times text-slate-400 xl:hidden mt-[calc(calc(calc(0.25rem*19.5)-24px)/2)]"
            sidenav-close>
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700 flex items-center ">
            <svg fill="#000000" height="calc(0.25rem*8)" width="calc(0.25rem*8)" version="1.1" id="Capa_1"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="-47.46 -47.46 569.49 569.49" xml:space="preserve" stroke="#000000" stroke-width="0.00474565"
                transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC"
                    stroke-width="3.79652"></g>
                <g id="SVGRepo_iconCarrier">
                    <g>
                        <path
        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full py-6 my-3 bg-slate-100 rounded-xl">
                <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <button type="submit" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors cursor-pointer">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
